    ...
    <head>
        ...
        <style>
            ...
            @media (max-width: 768px) {
                #sidebar { position: fixed; left: -220px; top: 0; bottom: 0; z-index: 999; transition: left 0.3s; }
                #sidebar.open { left: 0; }
                #menu-toggle {
                    display: block; position: fixed; top: 10px; left: 10px; z-index: 1000;
                    background: #00D4FF; color: #121212; border: none; padding: 8px 12px; border-radius: 4px; cursor: pointer;
                }
            }
        </style>
        <script>
        if ('serviceWorker' in navigator) {
          window.addEventListener('load', function() {
            navigator.serviceWorker.register('/assets/service-worker.js').catch(function(err){console.warn('SW reg failed', err)});
          });
        }
        </script>
    </head>
...
def serve_layout():
    """Return a professional root layout with refined controls and loading state."""
    return html.Div(
        className="app-container",
        children=[
            html.Button("Menu", id="menu-toggle"),
            html.Div(
                id="sidebar",
                children=[
            ...
            html.Div(
                id="main",
                children=[
                    # Professional header bar with title and status pill
                    html.Div(
                        [
                            html.H2(
                    ...
                    html.Div(
                        [
                            ...
                            dcc.Checklist(
                                ...
                                options=[{"label": " Auto Refresh (60s)", "value": "on"}],
                                value=[],
                                inputStyle={"marginRight": "6px"},
                                style={"color": DARK_THEME["text"], "marginLeft": "10px"},
